...
# Step 3a: Get video from Pexels (✅ 3 queries for variety)
...
# Step 3b: Get video from Pixabay as second source
...
# Step 3c: Get video from Mixkit as third source
...
# Step 3d: Generate video with FAL.ai as last fallback
...
# ✅ Try Pexels → Pixabay → Mixkit → FAL.ai
...
if not video_url:
    ...
    video_url = get_mixkit_video(idea)
