...
def get_trending_topic():
    try:
        ...
        # Extract first <title> after the channel title
        titles = []
        parts = content.split("<title>")
        for part in parts[2:7]:  # skip channel title, get first 5 articles
