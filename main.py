...
def generate_caption(idea, trend=None):
    try:
        ...
        trend_context = ""
        if trend:
            trend_context = f"\nCurrently trending in luxury world: {trend}\nUse this as inspiration if relevant."

        prompt = f"""You are a luxury travel content creator for Instagram Reels and Telegram.
Write a caption for a video about: {idea['title']}
{trend_context}

Format EXACTLY like this:
Line 1: One elegant aspirational sentence about the destination ✨
Line 2: empty line
Line 3: "🔗 Book your stay → {AFFILIATE_LINK}"
Line 4: empty line
Line 5: "📸 Save this for your next trip!"
Line 6: "👆 Link in bio"
Line 7: empty line
Line 8: 5-8 relevant hashtags: #LuxuryTravel #LuxuryResort #DreamVacation #TravelInspiration #LuxuryLife

English only. Aspirational tone. Max 300 chars before hashtags."""
        ...
        return f"✨ {fallback}\n\n🔗 Book your stay → {AFFILIATE_LINK}\n\n📸 Save this for your next trip!\n👆 Link in bio\n\n#LuxuryTravel #LuxuryResort #DreamVacation #TravelInspiration #LuxuryLife"
